        ...
        <tr>
            <td height="49" valign="top">
                <form name="form1" method="post" action="">
                    ...
                    <div align="center">
                        <input type="button" name="Button" value="Xem thông tin cá nhân" onClick="javascript:window.open('Info.php','_self')">
                        <input type="button" name="Button" value="Đăng xuất" onClick="javascript:window.open('Logout.php','_self')">
                    </div>
                </form>
            </td>
        </tr>
